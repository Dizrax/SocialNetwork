from socialnetwork.models import Session, User, Photo, Friendship, Friendrequest, Base, engine
...
fs1 = Friendship(user_from_id = 1, user_to_id = 2, dialogLocPath = 'socialnetwork/static/2-1.txt')
fs2 = Friendship(user_from_id = 2, user_to_id = 3, dialogLocPath = 'socialnetwork/static/2-3.txt')
